    ...
    <DashboardLayout userRole="driver" userName={currentUser?.name}>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Vehicle Information */}
          <Card>
            <h2 className="text-xl font-bold mb-4 text-gray-900">Vehicle Information</h2>
            <div className="space-y-4">
              <Input
        ...
        {/* Performance Stats */}
        <Card>
          <h2 className="text-xl font-bold mb-4 text-gray-900">Performance Statistics</h2>
        ...
        <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-200">
          <h3 className="text-lg font-bold mb-3 text-gray-900">🏆 Tier Progress</h3>
