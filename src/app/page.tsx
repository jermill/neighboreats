    ...
    <main className="min-h-screen bg-gray-50">
            ...
            <div className="text-center space-y-8 animate-fadeIn mb-12">
              ...
              <div className="flex items-center justify-center gap-4">
                ...
                <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold text-gray-900">
                  Neighbor<span className="text-amber-600">Eats</span>
                </h1>
              </div>
              
              <p className="text-3xl md:text-4xl lg:text-5xl text-gray-800 font-semibold max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center items-center pt-4 max-w-4xl mx-auto">
                <Link
                  ...
                  className="px-8 py-4 bg-brand-teal text-white font-bold rounded-xl hover:bg-brand-teal/90 transition-all shadow-lg hover:shadow-xl hover:scale-105 w-full sm:w-auto flex items-center justify-center gap-2 text-lg"
                >
                ...
                <Link
                  href="/apply/chef"
                  className="px-8 py-4 bg-brand-coral text-amber-950 font-bold rounded-xl hover:bg-amber-600 transition-all shadow-lg hover:shadow-xl hover:scale-105 w-full sm:w-auto flex items-center justify-center gap-2 text-lg"
                >
                ...
                <Link
                  href="/apply/driver"
                  className="px-8 py-4 bg-emerald-600 text-white font-bold rounded-xl hover:bg-emerald-700 transition-all shadow-lg hover:shadow-xl hover:scale-105 w-full sm:w-auto flex items-center justify-center gap-2 text-lg"
                >
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="bg-white rounded-2xl p-8 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 animate-fadeIn" style={{ animationDelay: '0.1s' }}>
            <div className="w-16 h-16 bg-gradient-to-br from-rose-100 via-amber-100 to-emerald-100 rounded-2xl flex items-center justify-center mb-4">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            <div className="w-16 h-16 bg-gradient-to-br from-rose-100 via-amber-100 to-emerald-100 rounded-2xl flex items-center justify-center mb-4">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-md hover:shadow-xl hover:scale-105 transition-all duration-300 animate-fadeIn" style={{ animationDelay: '0.3s' }}>
            <div className="w-16 h-16 bg-gradient-to-br from-rose-100 via-amber-100 to-emerald-100 rounded-2xl flex items-center justify-center mb-4">
        ...
        <div className="container mx-auto px-4">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300">
              <div className="relative h-80">
                <Image
                  ...
                  unoptimized
                />
                <div className="absolute top-4 right-4 bg-brand-coral text-amber-950 px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                  Home Cook
                </div>
              </div>
              <div className="p-6">
          ...
          <div className="text-center mt-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/auth/signup/customer"
                className="px-8 py-4 bg-brand-teal text-white font-semibold rounded-xl hover:bg-brand-teal/90 transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
                Join as Customer
              </Link>
              <Link
                href="/apply/chef"
                className="px-8 py-4 bg-brand-coral text-amber-950 font-semibold rounded-xl hover:bg-amber-600 transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
                Start Cooking
              </Link>
              <Link
                href="/apply/driver"
                className="px-8 py-4 bg-emerald-600 text-white font-semibold rounded-xl hover:bg-emerald-700 transition-all shadow-lg hover:shadow-xl hover:scale-105"
              >
                Start Driving
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-xl text-gray-700">
              ...
              <Link href="/auth/login" className="text-customer-500 font-bold hover:text-rose-700 hover:underline transition text-2xl">
                Log in
              </Link>
            </p>
          </div>
