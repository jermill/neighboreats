      ...
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-gray-400 dark:text-dark-text-muted mb-2">
          ...
          {/* For Customers */}
          <div>
            <h3 className="text-white dark:text-dark-text font-semibold mb-2 text-sm">For Customers</h3>
          ...
          {/* For Chefs & Drivers */}
          <div>
            <h3 className="text-white dark:text-dark-text font-semibold mb-2 text-sm">For Partners</h3>
            <ul className="space-y-1 text-xs">
              <li>
          ...
          {/* Company */}
          <div>
            <h3 className="text-white dark:text-dark-text font-semibold mb-2 text-sm">Company</h3>
            <ul className="space-y-1 text-xs">
              <li>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-800 dark:border-dark-border mt-6 pt-4">
